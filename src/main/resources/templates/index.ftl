...
<html lang="zh">
	...
	<head>
        ...
        <title>爱卑微</title>
        <link rel="shortcut icon" size="72x72" href="/images/index.png" />
        <link rel="shortcut icon" size="114x114" href="/images/index.png" />
	...
	<body class="home blog custom-background round-avatars">
		...
		<form class="js-search search-form search-form--modal" method="get" action="search.ftl" role="search">
			<div class="search-form__inner">
				<div>
					<div id="search-container" class="ajax_search">
						<form method="get" id="searchform" action="">
							<div class="filter_container"><input type="text" value="" autocomplete="off" placeholder="" name="s" id="search-input" />
		...
		<header id="masthead" class="overlay animated from-bottom" itemprop="brand">
			<div class="site-branding text-center">
				<a href="">
					<figure>
						<img class="custom-logo avatar" src="images/index.png" />
					</figure>
				</a>
					...
					<div class="posts-list js-posts">
							...
							<div class="status_list_item icon_kyubo">
								<div class="status_user" style="background-image: url(images/b0ce3f3cde0c084b6d42321b2dcbc407.jpeg);">
									<div class="status_section">
										<a href="detail.ftl" class="status_btn">交代是不可能交代的</a>
							...
							<div class="postnormal review ">
								<div class="post-container review-item">
									<div class="row review-item-wrapper">
										<div class="col-sm-3">
											<a rel="nofollow" href="detail.ftl">
												<div class="review-item-img" style="background-image: url(images/diego-ph-249471-2-800x1000.jpg);"></div>
											</a>
										</div>
										<div class="col-sm-9 flex-xs-middle">
											<div class="review-item-title">
												<a href="detail.ftl" rel="bookmark">我才不会写年终总结之瞎说篇</a>
											</div>
						...
						<div class="post post-layout-list" data-aos="fade-up">
							<div class="status_list_item icon_kyubo">
								<div class="status_user" style="background-image: url(images/b0ce3f3cde0c084b6d42321b2dcbc407.jpeg);">
									<div class="status_section">
										<a href="detail.ftl" class="status_btn">状态</a>
						...
						<div class="post post-layout-list js-gallery" data-aos="fade-up">
							<div class="post-album">
								<div class="row content">
									<div class="bg" style="background-image: url(images/IMG_0150.jpg);"></div>
									<div class="contentext flex-xs-middle">
										<div class="album-title">
											<a href="detail.ftl">重构图像样式测试</a>
										</div>
									...
									<div class="album-thumb-width flex-xs-middle">
										<div class="row album-thumb no-gutter">
											<div class="col-xs-4"><img class="thumb" src="images/IMG_0150-250x250.jpg" /></div>
											<div class="col-xs-4"><img class="thumb" src="images/IMG_0149-250x250.jpg" /></div>
											<div class="col-xs-4"><img class="thumb" src="images/IMG_0146-250x250.jpg" /></div>
											<div class="col-xs-4"><img class="thumb" src="images/IMG_0147-250x250.jpg" /></div>
											<div class="col-xs-4"><img class="thumb" src="images/IMG_0148-250x250.jpg" /></div>
											<div class="col-xs-4">
												<a href="">5 pics</a>
											</div>
										</div>
							...
							<div class="postnormal review ">
								<div class="post-container review-item">
									<div class="row review-item-wrapper">
										<div class="col-sm-3">
											<a rel="nofollow" href="detail.ftl">
												<div class="review-item-img" style="background-image: url(images/47fb3c_9afed6c259f94589881bd55376206366mv2_d_3840_5784_s_4_2-800x450.jpg);"></div>
											</a>
										</div>
										<div class="col-sm-9 flex-xs-middle">
											<div class="review-item-title">
												<a href="detail.ftl" rel="bookmark">给大家介绍一下</a>
											</div>
								...
								<div class="post-container">
									...
									<div class="post-footer">
										<a class="gaz-btn primary" href="detail.ftl">READ MORE</a>
		...
		<footer id="footer" class="overlay animated from-top">
			...
			<div class="socialize" data-aos="zoom-in">
				...
				<li class="wechat">
					...
					<div class="wechatimg"><img src="images/49D3746D-7519-B709-83E4-65BD1927C4E7.jpg"></div>
				</li>
				<li>
					<a title="QQ" class="socialicon" href="" target="_blank"><i class="iconfont" aria-hidden="true">&#xe616;</i></a>
				</li>
			</div>
			<div class="cr">Copyright@2019&nbsp;&nbsp;&nbsp;<a href="http://www.beian.miit.gov.cn" style="font-size: 15px;">豫ICP备18043238号</a></div>
